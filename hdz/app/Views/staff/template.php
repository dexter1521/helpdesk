                    ...
                    if(staff_data('admin') == 1){
                        ...
                        <li class="nav-item dropdown <?php echo (uri_page() == 'setup' ? 'show' : '');?>">
                            ...
                            <div class="dropdown-menu dropdown-menu-small <?php echo (uri_page() == 'setup' ? 'show' : '');?>">
                                ...
                                <a class="dropdown-item <?php echo strpos(uri_string(), 'setup/auto-assignment') !== false ? 'active' : '';?>" href="<?php echo site_url(route_to('staff_auto_assignment'));?>">
                                    <i class="fa fa-robot text-info"></i> Asignación Automática
                                </a>
